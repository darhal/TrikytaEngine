...
Physics2D::PhysicsBody* Drawable::Physicalize(float p_Mass, float p_Friction, Physics2D::BodyType p_Type, Vec2f p_Offset)
{
	...
	(
		...
		BodyShape::BOX, BodyParams{ p_Mass, p_Friction },
